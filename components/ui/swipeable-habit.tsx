...
export const SwipeableHabit = ({ habit, onComplete, onInfo }: SwipeableHabitProps) => {
  ...
  return (
    <div 
      className="relative overflow-hidden touch-pan-y focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-[#CCBA78] focus:outline-none rounded-md"
      tabIndex={0}
